...
public class WriteWrappersMethods {
    ...
    public static void ShowShort(Short short_value)
    {
    ...
    public static void ShowBigInteger(BigInteger bigInteger_value, Random rnd)
    {
